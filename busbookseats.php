...
$query = "insert into bus_bookdetails(amount,tot_seats,username,source,destination,date) values ($amt,$seats,'$sessvar','$from','$to','$date')";
...
<div>
	<form method="post" action="busdelete.php"><input type="submit" class="btn btn-primary" value="Cancel" name="cancel"></form>
</div>
