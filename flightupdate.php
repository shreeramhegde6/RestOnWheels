...
$result = mysqli_query($conn, "SELECT MAX(booking_id) FROM flight_bookdetails");
...
$query = "UPDATE flight_bookdetails SET amount = 500 * $total_seats,tot_seats = $total_seats WHERE booking_id = $last_seat" ;
