...
$query = "insert into flight_bookdetails(amount,tot_seats,username,source,destination,date) values ($amt,$seats,'$sessvar','$fromm','$too','$date')";
...
<div>
	<form method="post" action="flightdelete.php"><input type="submit" class="btn btn-primary" value="Cancel" name="cancel"></form>
</div>
